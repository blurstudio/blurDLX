...
//! TO BE DOCUMENTED
BOOL CoplanarTriTri(const Point3& n, const Point3& v0, const Point3& v1, const Point3& v2, const Point3& u0, const Point3& u1, const Point3& u2)
{
	float A[3];
	short i0,i1;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL TriTriOverlap(const Point3& V0, const Point3& V1, const Point3& V2, const Point3& U0, const Point3& U1, const Point3& U2)
{
	// Stats
//	mNbPrimPrimTests++;
	...
	Point3 E1 = V1 - V0;
	Point3 E2 = V2 - V0;
	const Point3 N1 = E1 ^ E2;
	const float d1 =DotProd(-N1 , V0);
	// Plane equation 1: N1.X+d1=0

	// Put U0,U1,U2 into plane equation 1 to compute signed distances to the plane
	float du0 = DotProd(N1, U0) + d1;
	float du1 = DotProd(N1, U1) + d1;
	float du2 = DotProd(N1, U2) + d1;
	...
	E1 = U1 - U0;
	E2 = U2 - U0;
	const Point3 N2 = E1 ^ E2;
	const float d2=DotProd(-N2 , U0);
	// plane equation 2: N2.X+d2=0

	// put V0,V1,V2 into plane equation 2
	float dv0 = DotProd(N2,V0) + d2;
	float dv1 = DotProd(N2,V1) + d2;
	float dv2 = DotProd(N2,V2) + d2;
